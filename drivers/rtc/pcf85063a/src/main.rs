//! The `Run` entry-point binary of the NXP PCF85063A real-time-clock driver,
//! installed as a signed `/System/Drivers/` bundle and **autoloaded into user
//! space** by `devmgr` when a `nxp,pcf85063a` node is discovered
...
mod program {
    ...
    use tairix_drv_rtc_pcf85063a::Pcf85063a;
    ...
    fn main() -> i32 {
        ...
        let Ok(mut rtc) = Pcf85063a::open(&host) else {
    ...
    fn serve(rtc: &mut Pcf85063a<&RtDriverHost<RtGrantSyscalls>>) -> i32 {
