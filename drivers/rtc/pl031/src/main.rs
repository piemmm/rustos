//! The `Run` entry-point binary of the PL031 real-time-clock driver,
//! installed as a signed `/System/Drivers/` bundle and **autoloaded into user
//! space** by `devmgr` when an `arm,pl031` node is discovered
...
mod program {
    ...
    use tairix_drv_rtc_pl031::Pl031;
    ...
    /// window is too short to hold the register block. A reserved value.
    ...
    fn main() -> i32 {
        ...
        let Ok(mut rtc) = Pl031::new(regs) else {
            return EXIT_BRINGUP_FAILED;
        };
