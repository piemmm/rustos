// Harness for the wasm32 leg of the world generator's determinism
...
const { world_digest, reference_digest } = instance.exports;

if (typeof world_digest !== 'function' || typeof reference_digest !== 'function') {
...
if (produced === 0n) {
  console.error('FAIL: the realm did not solve');
  process.exit(1);
}
