...
use tairix_arch_riscv64::preempt::{self, PreemptStorage};
...
const FAIL_NO_PREEMPT: NonZeroU16 = fail_point!(10);
const FAIL_PREEMPT_STORAGE: NonZeroU16 = fail_point!(11);
const FAIL_EXIT_COUNT: NonZeroU16 = fail_point!(12);
const FAIL_SOLE_PREEMPTED: NonZeroU16 = fail_point!(13);
const FAIL_SPAWN_COMPETITOR: NonZeroU16 = fail_point!(14);
