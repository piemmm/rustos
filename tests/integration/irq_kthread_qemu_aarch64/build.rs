//! Build-time fixture generator for the P11 Chunk B-2 INCREMENT (1)
//! aarch64 device-SPI -> parked-kthread vertical.
//!
...
fn main() {
    ...
    if target == AARCH64_TARGET {
        ...
        // this compiles only for the freestanding aarch64 target.
