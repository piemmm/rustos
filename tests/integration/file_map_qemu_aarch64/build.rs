//! Build-time fixture generator for the M1 aarch64 demand-paged
//! file-mapping vertical.
//!
//! Four jobs on the freestanding `aarch64-unknown-none` target:
//!
...
/// (pinning the shared fixture geometry into its build) and convert the
/// linked ELF into an `rxe` blob.
