//! Build script for the x86_64 two-process netstack live-boot QEMU vertical
//! (`plans/NETWORK.md` N4e / `plans/ARCHSUPPORT.md` A4).
//!
...
//! `autoload_input_qemu_x86_64` / `root_unlock_admission_qemu_x86_64` boot
