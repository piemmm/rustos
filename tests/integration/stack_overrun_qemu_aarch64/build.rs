//! Build script for the aarch64 stack-overrun (G3c) QEMU vertical.
//!
//! Two jobs on the freestanding `aarch64-unknown-none` target, mirroring
...
//!    handle's monotonic clock from the discovered timer frequency
