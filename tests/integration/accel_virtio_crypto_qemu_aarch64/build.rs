//! Build script for the virtio-crypto accelerator (aarch64) QEMU test.
//!
...
//! 2. Sign a synthetic virtio-crypto `.rxe` manifest requesting
...
const TEST_SEED: [u8; 32] = [
    0x61, 0x61, 0x72, 0x63, 0x68, 0x61, 0x63, 0x63, 0x65, 0x6c, 0x5f, 0x76, 0x63, 0x72, 0x79, 0x4b,
    0x1f, 0x8d, 0x63, 0xa2, 0x07, 0xc4, 0x39, 0xe1, 0x5b, 0x90, 0x2e, 0x76, 0xd8, 0x41, 0xba, 0x03,
];
...
fn main() {
    ...
    // The virtio-crypto driver's `register` entry checks `CAP_DRV_LOAD`,
    ...
    out.push_str("/// Signed virtio-crypto `.rxe` image bytes.\n");
