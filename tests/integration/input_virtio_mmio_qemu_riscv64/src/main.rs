//! WIRING QEMU integration test: drive a real (emulated) virtio-input
//! device over the riscv64 `virt` board's virtio-MMIO bus end-to-end,
//! decoding a key the QEMU runner injects through the monitor.
//!
