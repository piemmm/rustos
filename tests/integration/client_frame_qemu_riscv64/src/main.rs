...
mod kernel {
    ...
    /// Static boot heap. The realm field, the generated chunks, the synthesised
    ...
    #[panic_handler]
    fn client_frame_qemu_riscv64_panic(info: &PanicInfo<'_>) -> ! {
    ...
    pub extern "C" fn kernel_main(_hartid: u64, _dtb: u64) -> ! {
        ...
        if produced == REFERENCE_DIGEST {
            ...
            note(TEST_PASS, "client frame: riscv64 agrees with the reference");
