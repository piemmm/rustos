...
mod kernel {
    ...
    #[panic_handler]
    fn figure_determinism_qemu_aarch64_panic(info: &PanicInfo<'_>) -> ! {
    ...
    pub extern "C" fn kernel_main(_dtb: u64) -> ! {
        // The figure engine is floating-point throughout, and EL1 traps
        ...
        if produced == REFERENCE_DIGEST {
            ...
            note(
                TEST_PASS,
                "figure determinism: aarch64 agrees with the reference",
            );
