//! Build script for the riscv64 DHCPv4 netstack live-boot QEMU vertical
//! (`plans/DHCP.md` D3).
//!
...
//! `netstack_static_qemu_riscv64` / `netstack_autoload_qemu_riscv64` boot
...
//! here — the planted virtio-blk disk and the attached `virtio-net-device`
//! populate the board's `virtio,mmio` transport slots, which the
