//! Build script for the aarch64 value-pipe QEMU vertical
//! (`plans/ALIAS.md` §6.2 — reading a value-backed resource reference
//! through the shell's input redirection).
//!
