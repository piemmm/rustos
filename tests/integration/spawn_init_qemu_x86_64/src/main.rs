...
//! `tairix-kernel` pipeline, spawn PID 1 (`init`) into **ring 3**, and prove
...
//! backing (`BootInfo::with_consoles`). After `kernel_core::kernel_main` emits
...
mod kernel {
    ...
    #[panic_handler]
    fn tairix_spawn_init_qemu_x86_64_panic(info: &PanicInfo<'_>) -> ! {
