//! Build script for the Stage W11-B virtio-input-mmio (aarch64) QEMU test.
//!
...
//! 2. Sign a synthetic virtio-input `.rxe` manifest requesting
...
const TEST_SEED: [u8; 32] = [
    0x61, 0x61, 0x72, 0x63, 0x68, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x5f, 0x76, 0x69, 0x6f, 0x31, 0x9c,
    0x4d, 0x2b, 0xe7, 0x06, 0x83, 0xa1, 0x55, 0xff, 0x18, 0x6c, 0xb0, 0x39, 0xd4, 0x72, 0x0e, 0x95,
];
...
fn main() {
    ...
    // The virtio-input driver's `register` entry checks `CAP_DRV_LOAD`,
    ...
    out.push_str("/// Signed virtio-input `.rxe` image bytes.\n");
...
/// MiB, 1 CPU); the virtio-mmio transport bases and SPIs the test reads
/// from it are the stable `virt`-board layout, independent of which slot
/// the keyboard device lands on.
