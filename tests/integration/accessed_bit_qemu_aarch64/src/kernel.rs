...
const FAIL_MISALIGNED_EDGE: u16 = 4;
const FAIL_UNMAPPED_EDGE: u16 = 5;
const FAIL_SEED_READBACK: u16 = 6;
const FAIL_PROBE_FRESH: u16 = 7;
const FAIL_PROBE_COLD: u16 = 8;
const FAIL_PROBE_AFTER_FAULT: u16 = 9;
const FAIL_PROBE_COLD_AGAIN: u16 = 10;
const FAIL_PROBE_REACCESS: u16 = 11;
const FAIL_UNEXPECTED_FAULT: u16 = 12;
...
fn fail(id_msg: &'static str, code: u16) -> ! {
