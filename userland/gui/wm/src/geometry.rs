...
//!
//! Screen coordinates are signed (`i32`): a window may be positioned
//! partly off the top or left edge. Sizes are unsigned (`u32`). All
//! arithmetic is overflow-checked through `i64`/`u32` widening so a
//! pathological coordinate fails closed rather than wrapping (§2.9).
