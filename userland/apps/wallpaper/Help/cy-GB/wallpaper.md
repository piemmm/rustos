...
Mae'r grid yn rhestru pob papur wal a ddarperir fel rhagolwg bach, ynghyd
â chofnod **No wallpaper** (Dim papur wal) sy'n dangos y lliw cefndir a
ddewiswyd yn unig. Mae pob rhagolwg yn cael ei rendro o dan y ffit a
ddewiswyd ar hyn o bryd, felly mae rhagolwg yn dangos yr hyn y bydd y
bwrdd gwaith yn ei wneud mewn gwirionedd gyda'r ddelwedd honno. Mae
ffeil na ellir ei dadgodio yn dangos teilsen dal lle wedi'i marcio â'i
henw ac ni cheisir ei hagor eto.
...
delwedd gamffurfiedig beryglu'r dewiswr na'r bwrdd gwaith.

Y rhesi opsiynau o dan y grid yw:
...
- **Backdrop** (Cefndir) — y lliw gwastad a ddangosir lle bynnag nad yw'r
  ...
  hunan.
- **Icons** (Eiconau) — o ba ochr i'r bwrdd pinio y mae grid eiconau'r
  bwrdd gwaith yn tyfu.
- **Sort** (Trefnu) — y drefn y rhestrir eiconau ffolder y bwrdd gwaith.

Caiff y ffenestr ei gyrru gan y fysellfwrdd. Mae `Tab` a `Shift-Tab` yn
symud y ffocws ymlaen ac yn ôl trwy'r grid, y rhesi opsiynau, a'r
botymau. Mae'r bysellau saeth yn symud o fewn y grid rhagolygon, neu'n
newid yr opsiwn sydd â ffocws. Mae `Enter` yn actifadu'r botwm sydd â
ffocws, ac mae `Escape` yn cau'r ffenestr heb gymhwyso.
...
ysgrifennu'r gosodiadau ei hun. Adroddir y canlyniad ar y llinell statws
o dan y rhesi opsiynau: wedi'i gymhwyso, wedi'i wrthod gyda rheswm y
sesiwn, neu ddim sesiwn bwrdd gwaith yn gwrando. Mae gwrthodiad yn gadael
y ffenestr yn agored gyda'r dewis yn gyfan.

Dim ond y siop papurau wal a ddarperir sy'n cael ei chynnig; ni ellir
dewis delwedd mewn man arall ar y system o'r ffenestr hon. Nid yw
cliciadau pwyntydd yn dewis dim.
