...
//! `rustos_procinfo::IpcTransport` for the `sysinfo-v1` `MOUNT_LIST` query,
...
//! shared `rustos_help::BundleHelp` for the short-help switches, and
...
mod program {
    ...
    use rustos_df::{parse, run, Output, PathProbe, USAGE};
