//! RustOS `lsusb`: list the discovered USB devices
...
//!
//! The option surface follows `usbutils` `lsusb` over what the RustOS
...
//! deliberately and documents it: RustOS has no Linux bus/devnum
