...
//! shared `rustos_help::BundleHelp`, which reads the tool's own bundle's
...
mod program {
    ...
    use rustos_abi::fs::{FileKind, OpenFlags};
    use rustos_abi::Errno;
    use rustos_help::BundleHelp;
    use rustos_rt::io::{write_stderr_line, Stderr, Stdout, Write};
    use rustos_rt::File;
    use rustos_wc::{parse, run, FileSource, Input, Output, SizeProbe, USAGE};
