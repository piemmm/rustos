//! The parsed shape of a `userdel` command line.

use alloc::string::String;

/// One thing the `userdel` tool can do.
...
///
/// Exactly one operand is required. The account name is not validated
