...
Das Terminal wird aus dem Startmenü des Desktops (Eintrag `Terminal`)
oder namentlich aus einer Shell gestartet. Es benötigt eine laufende
grafische Sitzung: ohne sie ist der Fensterkanal unerreichbar, und das
Terminal meldet die Ablehnung auf dem Standardfehlerstrom und beendet
sich.
