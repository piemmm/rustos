...
//!
//! A first-party driver that runs in **user space** (the §4 microkernel goal)
...
//! hardware-tree node requested (`AGENTS.md` §18.3 — and *no more*, §4), and
...
//! of the trap (`AGENTS.md` §5.4). A forged or another task's handle resolves
...
//! pointer or a panic (`AGENTS.md` §2.9).
//!
//! # Testing seam
//!
...
//! to `rustos_rt`'s wrappers — the one syscall trap (`AGENTS.md` §2.2).
