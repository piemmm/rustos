...
pub use kstats::{
    ...
    memory_pressure_band, memory_total_bytes, net_stack_defence, ramzip_stats, CACHE_LEDGER_PAGE,
    CPU_LOAD_PAGE, DESKTOP_FRAME_PAGE, IRQ_PAGE, NET_INTERFACE_PAGE, RECLAIM_PAGE,
};
