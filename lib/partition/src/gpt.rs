...
pub fn classify(type_guid: &[u8; 16]) -> PartitionType {
    ...
    } else if *type_guid == TYPE_GUID_ARXFS_SYSTEM {
        PartitionType::ARXFSSystem
    } else if *type_guid == TYPE_GUID_ARXFS_ROOT {
