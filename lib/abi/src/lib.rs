...
pub use appinfo::{
    ...
    APPINFO_MAX_CAPABILITIES, APPINFO_MAX_MIME, APPINFO_WIRE_MAX, BUNDLE_CONTENT_DIGEST_MAGIC,
    BUNDLE_ID_MAX, BUNDLE_NAME_MAX, BUNDLE_SUFFIX, BUNDLE_VERSION_MAX, HOME_APPLICATION_STORE_DIR,
    HOME_COMMAND_STORE_DIR, INSTALLED_APP_STORE, LIBRARY_ICON_MAX, MIME_ENTRY_LEN, MIME_TYPE_MAX,
