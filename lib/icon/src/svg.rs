...
//!
//! Desktop icons are authored as SVG (the SVG-first asset rule). A decoded [`SvgImage`] is already a square design grid plus an
...
//! `lib/raster`'s single polygon path. Unlike the built-in
