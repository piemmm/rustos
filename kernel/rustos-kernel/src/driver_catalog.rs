...
//! belong in the discovered tier, never the floor (`AGENTS.md` §18.6).
...
pub struct InKernelDriver {
    ...
    /// and cannot drift from a parallel list (`AGENTS.md` §2.2).
...
mod tests {
    ...
    fn the_registry_is_authored_from_the_driver_crates_bind_keys() {
        ...
        // (`AGENTS.md` §2.2 / §18.3). The compiled-in floor is storage-only
        // (`AGENTS.md` §18.6): everything else autoloads from the store.
        assert_eq!(
    ...
    fn only_the_storage_floor_entries_provide_the_root_block() {
        ...
        // An unknown path is not a block driver (fail closed, §2.9). A
