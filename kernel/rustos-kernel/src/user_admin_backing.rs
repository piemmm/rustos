...
mod tests {
    ...
    fn persist_replaces_both_databases_whole_and_keeps_their_security() {
        ...
        backing
            .persist("rustos-users-v1\n", "rustos-groups-v1\n")
            .expect("persists");
        assert_eq!(read_file(&backing, b"Users"), b"rustos-users-v1\n");
        assert_eq!(read_file(&backing, b"Groups"), b"rustos-groups-v1\n");
    ...
    fn persist_fails_closed_when_a_database_is_missing() {
        ...
        assert_eq!(
            backing.persist("rustos-users-v1\n", "rustos-groups-v1\n"),
            Err(Errno::NotFound)
        );
    }
