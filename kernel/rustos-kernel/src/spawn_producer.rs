...
use rustos_kernel_core::{
    spawn_image, AdmitError, EmbeddedProgram, ProcessSpawn, ProgramRegistry, SpawnCallerError,
    SpawnCtx, SpawnRequest,
};
...
impl ProcessSpawn for Aarch64ProcessSpawn {
    fn spawn(&self, rxe: &[u8], ctx: &dyn SpawnCtx) -> Result<u64, Errno> {
        ...
        // `space`, `physmap` backs them, and `pre_resume` activates the
        // child's root before it is first entered — the `admit_process`
        // contract.
