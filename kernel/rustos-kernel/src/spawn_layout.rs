...
use crate::program_manifests::{
    ...
    SYSINFO_MANIFEST, SYSMON_MANIFEST, TOP_MANIFEST, USERS_TOOL_MANIFEST,
};
...
use program_rxes::{
    ...
    SHELL_RXE, SYSINFOD_RXE, SYSINFO_RXE, SYSMON_RXE, TOP_RXE, USERS_CLI_RXE,
};
...
pub use crate::spawn_paths::{
    ...
    SEATMGR_PATH, SHELL_PATH, SYSINFOD_PATH, SYSINFO_PATH, SYSMON_PATH, TOP_PATH, USERS_CLI_PATH,
};
...
#[cfg(not(all(freestanding, kernel_isa = "aarch64")))]
pub static SPAWN_PROGRAMS: [EmbeddedProgram; 15] = [
    EmbeddedProgram {
        path: SHELL_PATH,
        rxe: SHELL_RXE,
        caps: SHELL_MANIFEST,
