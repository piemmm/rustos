...
use crate::program_manifests::{
    CAT_MANIFEST, DEVMGR_MANIFEST, LOGIN_MANIFEST, LS_MANIFEST, MAN_MANIFEST, PS_MANIFEST,
...
#[cfg(not(all(freestanding, kernel_isa = "aarch64")))]
use program_rxes::{
    CAT_RXE, DEVMGR_RXE, LOGIN_RXE, LS_RXE, MAN_RXE, PS_RXE, SHELL_RXE, SYSINFOD_RXE, SYSINFO_RXE,
...
#[cfg(not(all(freestanding, kernel_isa = "aarch64")))]
pub static SPAWN_PROGRAMS: [EmbeddedProgram; 11] = [
    EmbeddedProgram {
        path: SHELL_PATH,
        rxe: SHELL_RXE,
