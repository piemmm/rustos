...
use crate::program_manifests::{
    ...
    PS_MANIFEST, RESET_MANIFEST, SESSION_BASELINE, SYSINFOD_MANIFEST, SYSINFO_MANIFEST,
...
#[cfg(not(all(freestanding, kernel_isa = "aarch64")))]
use program_rxes::{
    CAT_RXE, CLEAR_RXE, DEVMGR_RXE, LOGIN_RXE, LS_RXE, MAN_RXE, PS_RXE, RESET_RXE, SHELL_RXE,
    SYSINFOD_RXE, SYSINFO_RXE, TOP_RXE, USERS_CLI_RXE,
};
...
#[cfg(not(all(freestanding, kernel_isa = "aarch64")))]
pub static SPAWN_PROGRAMS: [EmbeddedProgram; 13] = [
    EmbeddedProgram {
        path: SHELL_PATH,
        rxe: SHELL_RXE,
