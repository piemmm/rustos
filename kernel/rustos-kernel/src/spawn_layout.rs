...
use crate::program_manifests::{
    DEVMGR_MANIFEST, INIT_MANIFEST, LOGIN_MANIFEST, MAN_MANIFEST, PS_MANIFEST, SESSION_BASELINE,
...
pub use crate::spawn_paths::{
    DEVMGR_PATH, LOGIN_PATH, MAN_PATH, PS_PATH, SHELL_PATH, SYSINFOD_PATH, SYSINFO_PATH, TOP_PATH,
    USERS_CLI_PATH,
};
...
pub static SPAWN_PROGRAMS: [EmbeddedProgram; 9] = [
    EmbeddedProgram {
        path: SHELL_PATH,
        rxe: SHELL_RXE,
