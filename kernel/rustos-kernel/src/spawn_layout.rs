...
use crate::program_manifests::{
    DEVMGR_MANIFEST, LOGIN_MANIFEST, LS_MANIFEST, MAN_MANIFEST, PS_MANIFEST, SESSION_BASELINE,
    SYSINFOD_MANIFEST, SYSINFO_MANIFEST, TOP_MANIFEST, USERS_TOOL_MANIFEST,
};
...
#[cfg(not(all(freestanding, kernel_isa = "aarch64")))]
use program_rxes::{
    DEVMGR_RXE, LOGIN_RXE, LS_RXE, MAN_RXE, PS_RXE, SHELL_RXE, SYSINFOD_RXE, SYSINFO_RXE, TOP_RXE,
    USERS_CLI_RXE,
};
