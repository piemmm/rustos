...
//! [`PlatformDiscovery`](rustos_arch_api::PlatformDiscovery) seam, so it is
...
mod tests {
    ...
    use rustos_abi::{HwDeviceClass, HwNode, HW_NODE_ROOT, HW_NODE_ROOT_ID};
    use rustos_arch_api::HwNodeSink;
