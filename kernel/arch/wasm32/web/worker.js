// RustOS wasm32 secondary-CPU worker bootstrap (`plans/WIRING.md` Stage
// W8).
//
...
// main thread (`rustos.js` `boot`/`startWorker`) constructs this module
...
// `rustos.js`; this file is only the worker-side entry point, kept
// dependency-free like the rest of the host glue (`AGENTS.md` §2.12).

import { runWorker } from "./rustos.js";
