...
impl TaskCtx {
    ...
    /// 16-byte aligned (AAPCS64 stack alignment) and non-zero.
    ///
    ...
    pub fn prepare(
        ...
        // is mapped, exclusive to this CPU, and writable; the frame fits
...
pub enum PrepareError {
    /// `stack_top` was zero.
    NullStack,
    /// `stack_top` was not 16-byte aligned (AAPCS64).
    Misaligned,
