...
//! [`crate::stack_arena::guarded_kernel_stack`] builder, so the guard page is
//! re-expressed at 4 KiB granularity and unmapped in PID 1's *own* Sv39 root
//! and an overrun takes a synchronous store page fault under its `satp`
//! (`plans/PI.md` G3b-2).
