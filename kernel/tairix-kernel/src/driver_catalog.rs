...
//!
//! Matching is the shared [`tairix_devmatch`] policy: a discovered
...
use tairix_drvhost::DriverEntry;
...
pub static IN_KERNEL_DRIVERS: [InKernelDriver; IN_KERNEL_DRIVER_COUNT] = [
    ...
    InKernelDriver {
        ...
        register: tairix_drv_storage_virtio_blk::register,
    ...
    InKernelDriver {
        ...
        image: EMMC2_IMAGE,
        register: tairix_drv_storage_emmc2::register,
        provides_root_block: true,
    },
];
...
mod tests {
    ...
    fn the_registry_is_authored_from_the_driver_crates_bind_keys() {
        ...
        assert_eq!(
            ...
            tairix_drv_storage_virtio_blk::BIND_KEYS
        );
        ...
        assert_eq!(
            ...
            tairix_drv_storage_emmc2::BIND_KEYS
        );
    }
