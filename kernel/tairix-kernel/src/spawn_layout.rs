...
use crate::program_manifests::{
    CAT_MANIFEST, CLEAR_MANIFEST, DEVMGR_MANIFEST, FONTD_MANIFEST, LOGIN_MANIFEST, LS_MANIFEST,
    MAN_MANIFEST, NETSTACK_MANIFEST, PS_MANIFEST, RESET_MANIFEST, SEATMGR_MANIFEST, SHELL_MANIFEST,
...
#[cfg(not(all(freestanding, kernel_isa = "aarch64")))]
use program_rxes::{
    CAT_RXE, CLEAR_RXE, DEVMGR_RXE, FONTD_RXE, LOGIN_RXE, LS_RXE, MAN_RXE, NETSTACK_RXE, PS_RXE,
    RESET_RXE, SEATMGR_RXE, SHELL_RXE, STRESS_RXE, SYSINFOD_RXE, SYSINFO_RXE, SYSMON_RXE, TOP_RXE,
    USERS_CLI_RXE,
};
...
pub use crate::spawn_paths::{
    CAT_PATH, CLEAR_PATH, DEVMGR_PATH, FONTD_PATH, LOGIN_PATH, LS_PATH, MAN_PATH, NETSTACK_PATH,
    PS_PATH, RESET_PATH, SEATMGR_PATH, SHELL_PATH, STRESS_PATH, SYSINFOD_PATH, SYSINFO_PATH,
...
#[cfg(not(all(freestanding, kernel_isa = "aarch64")))]
pub static SPAWN_PROGRAMS: [EmbeddedProgram; 18] = [
    EmbeddedProgram {
        path: SHELL_PATH,
        rxe: SHELL_RXE,
        caps: SHELL_MANIFEST,
