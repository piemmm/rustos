...
use crate::program_manifests::{
    CAT_MANIFEST, CLEAR_MANIFEST, CONFD_MANIFEST, DEVMGR_MANIFEST, FONTD_MANIFEST, LOGIN_MANIFEST,
    LS_MANIFEST, MAN_MANIFEST, NETSTACK_MANIFEST, PS_MANIFEST, RESET_MANIFEST, SEATMGR_MANIFEST,
    SHELL_MANIFEST, STRESS_MANIFEST, SYSINFOD_MANIFEST, SYSINFO_MANIFEST, SYSMON_MANIFEST,
    TIMED_MANIFEST, TOP_MANIFEST, USERS_TOOL_MANIFEST,
};
...
#[cfg(not(all(freestanding, kernel_isa = "aarch64")))]
use program_rxes::{
    CAT_RXE, CLEAR_RXE, CONFD_RXE, DEVMGR_RXE, FONTD_RXE, LOGIN_RXE, LS_RXE, MAN_RXE, NETSTACK_RXE,
    PS_RXE, RESET_RXE, SEATMGR_RXE, SHELL_RXE, STRESS_RXE, SYSINFOD_RXE, SYSINFO_RXE, SYSMON_RXE,
    TIMED_RXE, TOP_RXE, USERS_CLI_RXE,
};
...
#[cfg(not(all(freestanding, kernel_isa = "aarch64")))]
pub static SPAWN_PROGRAMS: [EmbeddedProgram; 20] = [
    EmbeddedProgram {
        path: SHELL_PATH,
        rxe: SHELL_RXE,
        caps: SHELL_MANIFEST,
