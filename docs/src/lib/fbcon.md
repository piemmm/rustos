...
shared `rustos_font` Inconsolata EX + M PLUS 1 Code coverage atlas: 15×28 cells
with 16-level anti-aliased coverage, Japanese hiragana/katakana/kanji alongside
the primary face's Latin/Greek/Cyrillic repertoire, and a U+FFFD fallback for
anything the merged family does not map. Double-width glyphs occupy a lead plus
