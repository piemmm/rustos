...
#define TAIRIX_DRIVER_ERROR_MEDIUM_ERROR ((int32_t)16)
#define TAIRIX_DRIVER_ERROR_DEVICE_OFFLINE ((int32_t)17)
#define TAIRIX_DRIVER_ERROR_TOO_MANY_LINKS ((int32_t)18)
