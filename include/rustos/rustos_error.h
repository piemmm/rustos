...
#define ROS_E_ADDRESS_IN_USE 34
#define ROS_E_ADDRESS_UNAVAILABLE 35
#define ROS_E_NETWORK_UNREACHABLE 36
#define ROS_E_NOT_CONNECTED 37
#define ROS_E_LIMIT_EXCEEDED 38
